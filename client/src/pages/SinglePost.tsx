    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-12 p-4">
        <div className="w-full lg:w-2/3 flex flex-col gap-7">
            ...
            {user?.id === post.uid && (
              <div className="flex gap-2 w-96">
                <Link to={`/post?id=${postId}`} state={post}>
                  <CiEdit className="w-5 h-5 cursor-pointer text-gray-900" />
                </Link>
                <CiTrash
          ...
          <h1 className="text-2xl lg:text-4xl font-bold hyphen-auto text-gray-900">
            {post.title}
          </h1>
                  ...
                  <div className="flex justify-between">
                    ...
                    {user?.id === comment.user_id && (
                      <div className="flex gap-2">
                        <CiEdit
                          className="w-5 h-5 cursor-pointer text-gray-900"
                          onClick={() => {
